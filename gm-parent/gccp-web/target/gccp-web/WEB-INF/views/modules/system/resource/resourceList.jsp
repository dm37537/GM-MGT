...
<body>
    <form:form id="searchForm" modelAttribute="resourceMessage" action="${ctx}/system/resource" method="post" class="breadcrumb form-search">
        ...
        <div>
            ...
            &nbsp;&nbsp;<a href="${ctx}/system/resource/addForm" class="btn btn-primary"><m:message bundle="common" key="common.add"/></a></shiro:hasPermission>
        </div>
    </form:form>
            ...
            <tr>
                ...
                <td>
                    <shiro:hasPermission name="resource_update">
                       <a href="${ctx}/system/resource/updateForm?locale=${resource.locale}&key=${resource.key}&bundle=${resource.bundle}"><m:message bundle="common" key="common.modify"/></a>
                    </shiro:hasPermission>
