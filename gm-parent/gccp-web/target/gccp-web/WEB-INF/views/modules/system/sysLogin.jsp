...
<div class="navbar navbar-fixed-top" >
    <div class="navbar-inner" style="background-color: #202125">
        <div class="container">
            ...
            <a class="brand" href="${ctx}"><img src="${ctxStatic}/images/logo.gif" alt="GM Platform"
                                                style="height:40px;"></a>
        </div>
    </div>
    <!--[if lte IE 10]>
...
<div class="container">
    ...
    <div id="login-wraper">
        <form id="loginForm" class="form login-form" action="${ctx}/login" method="post">
            <legend><span style="color:#08c;">GM<m:message bundle="common" key="common.system.login"/></span></legend>
            <div class="body">
