...
<body>
    <ul class="breadcrumb">
        <li class="active">修改参数信息</li>
    </ul>
    <tags:message message="${message}"/>
    <form:form id="inputForm" modelAttribute="parameter" action="${ctx}/system/activitysetting/updateParam" method="post" class="form-horizontal">
        <div class="container-fluid">
            <div class="span6">
                ...
                <div class="control-group">
                    <label class="control-label">game key:</label>
                    <form:input path="gameKey" htmlEscape="false" class="required" maxlength="100" />
                </div>

                <div class="control-group">
                    <label class="control-label">前置key:</label>
                    <form:input path="premiseKey" htmlEscape="false" class="required" maxlength="100" />
                </div>
                ...
                <div class="control-group">
                    ...
                    <form:select path="type">
                        <c:forEach items="${fns:getDictList('action_param_type')}" var="type">
                            <option value="${type.value}" <c:if test="${parameter.type eq type.value}">selected="true"</c:if> >${type.label}</option>
                        </c:forEach>
                    </form:select>
                </div>
