...
<body>
    ...
    <form:form id="inputForm" modelAttribute="action" action="${ctx}/system/actionsetting/add" method="post" class="form-horizontal">
        <tags:message message="${message}"/>
        <div class="container-fluid">
            <div class="span8">
                <div class="control-group">
                    <label class="control-label input-small">编号:</label>
                ...
                <div class="control-group">
                    ...
                    <form:select id="game" path="gameId">
                        <c:forEach items="${fns:getGameList()}" var="game">
                            <option value="${game.id}"><m:message bundle="common" key="${game.gameName}"/></option>
                        </c:forEach>
                    </form:select>
