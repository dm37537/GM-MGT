...
<head>
    ...
    <script type="text/javascript">
        ...
        function showParamWindow(paramId){
            top.$.jBox.open("iframe:${ctx}/system/activitysetting/listParamValue?paramId="+paramId, "集合值列表", 500, 700,{
                loaded:function(h){
...
<body>
    <ul class="breadcrumb">
        <li>
            <a href="${ctx}/system/activitysetting">活动配置</a><span class="divider">/</span>
        </li>
    ...
    <div class="row-fluid">
        <div id="left" class="span6">
            ...
            <div class="span12 breadcrumb">
                ...
                <a class="btn btn-primary pull-right" href="${ctx}/system/activitysetting/addParamForm?activityId=${activityId}" target="paramContent">添加参数</a>
            </div>
            </shiro:hasPermission>
                ...
                <c:forEach items="${list}" var="parameter">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="${ctx}/system/activitysetting/updateParamForm?id=${parameter.id}" target="paramContent"><m:message bundle="common" key="common.modify"/></a>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="activitysetting_delete">
                            <a href="${ctx}/system/activitysetting/deleteParam?id=${parameter.id}&activityName=${activityName}" onclick="return confirmx('<m:message bundle="common" key="common.deleteall.confirm"/>?', this.href)"><m:message bundle="common" key="common.delete"/></a>
                            </shiro:hasPermission>
