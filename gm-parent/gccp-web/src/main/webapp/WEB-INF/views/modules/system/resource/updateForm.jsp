...
<form:form id="inputForm" modelAttribute="resource" action="${ctx}/system/resource/update" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <form:input path="locale" htmlEscape="false" maxlength="100" class="required" readonly="true"/>
    </div>
    <div class="control-group">
        <label class="control-label">bundle:</label>
        <form:input path="bundle" htmlEscape="false" maxlength="100" class="required" readonly="true"/>
    </div>
    <div class="control-group">
        <label class="control-label">key:</label>
        <form:input path="key" htmlEscape="false" maxlength="200" class="required" readonly="true"/>
    </div>
    <div class="control-group">
