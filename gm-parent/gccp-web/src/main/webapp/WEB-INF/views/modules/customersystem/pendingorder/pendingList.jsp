...
<body>
<form:form id="searchForm" action="${ctx}/customersystem/pendingorder" method="post" modelAttribute="queryCondition" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
    <thead><tr>
        ...
        <th><m:message bundle="common" key="common.operate"/></th>
        <tbody>
        <c:forEach items="${page.list}" var="order">
    <tr>
        <td><a href="${ctx}/customersystem/pendingorder/pendingOrderForm?id=${order.id}">${order.id}</a></td>
        <td>${order.type}</td>
        <td><a href="${ctx}/customersystem/pendingorder/pendingOrderForm?id=${order.id}">${order.title}</a></td>
        <td>${order.roleId}</td>
        ...
        <td><a class="btn btn-mini btn-success">领取</a>&nbsp;
            <a class="btn btn-mini btn-warning">转交</a>&nbsp;
            <a class="btn btn-mini btn-danger"><m:message bundle="common" key="common.delete"/></a></td>
    </tr>
    </c:forEach>
    </tbody>
</table>
