...
public class User extends IEntity {
    ...
    Map<String,Pms_config> permissions= Maps.newHashMap();
    public User() {
    }
    ...
    public boolean isAdmin() {
        return Global.getConfig("adminid").contains(this.id+",");
    }
    ...
    public Map<String, Pms_config> getPermissions() {
        return permissions;
    }

    public void setPermissions(Map<String, Pms_config> pms) {
